...
import network
import urequests
import utime as timee

# Network settings
#wifi_ssid = "Vodafone-36CC_EXT"
#wifi_password = "Sowka111"
wifi_ssid = "Patrick Szalewicz"
wifi_password = "01020102..aA"
...
def scan_and_connect():
    ...
    station.active(True)
    time.sleep(1)
    #station.config(pm=station.PM_NONE) # disable power management
